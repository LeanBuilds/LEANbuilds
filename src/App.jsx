    ...
    <main className="min-h-screen bg-white text-gray-900 p-10">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="border rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition">
          ...
          <p>We collaborate with architects, engineers, and technologists to bring precision to your vision—through site verification, as-built modeling, and digital integration.</p>
        </div>
        <div className="border rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition">
          <h2 className="text-2xl font-semibold mb-3">Contractors</h2>
          <p>From cut lists to photogrammetry to site logistics—LEANBuilds supports field teams and site supervisors with practical services that reduce waste and increase efficiency.</p>
        </div>
        <div className="border rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition">
          <h2 className="text-2xl font-semibold mb-3">Owners</h2>
          <p>We provide clarity to owners and developers by delivering accurate site data, construction insight, and planning support—helping you make informed decisions from start to finish.</p>
        </div>
      </section>

      <footer className="mt-20 text-center text-sm text-gray-600">
        <p className="text-base font-medium">Contact</p>
        <p><a href="tel:+17054930733" className="hover:underline">(705) 493-0733</a></p>
        <p><a href="mailto:jesse.graham@leanbuilds.ca" className="hover:underline">jesse.graham@leanbuilds.ca</a></p>
